  ...
  static DifficultyConfig forLevel(int level) {
    ...
    if (level <= 50) {
      return DifficultyConfig(
        ...
        categoryCount: level.isEven ? 4 : 5,
    ...
    if (level <= 250) {
      return DifficultyConfig(
        ...
        categoryCount: 6 + ((level - 101) ~/ 50).clamp(0, 2),
    ...
    return DifficultyConfig(
      ...
      categoryCount: (6 + tier).clamp(6, 10),
